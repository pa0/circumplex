---
title: "Adaptacja polskich wersji narzędzi do badania współczesnej integracyjnej teorii interpersonalnej"
subtitle: "Circumplex Scales of Interpersonal Values (CSIV); Interpersonal Sensitivity Circumplex (ISC); Inventory of Interpersonal Problems (IIP-C)"
abstract: |
...
dane$set <- factor(dane$set, levels = 1:3, labels = c("A","B","C"))
...
Inwentarz osobowości dla ICD-11 (PiCD), Self and Interpersonal Functioning Scale (SIFS)
...
We used [@R-base] for all our analyses.
...
`{ rtt_alfa, child = "analiza-Rzetelnosc.Rmd"} # ToDo: Agnieszka`
...
`{ roznice, child="analiza-Diff.Rmd"} # ToDo: Paweł`
